...
// Стилі для поля вводу (аналогічно CardInput)
...
// Стилі для підсказки (аналогічно CardInput)
...
// Стилі для картки з інформацією про рахунок
export const InfoCard = styled.div`
  width: 100%;
  max-width: ${getInfoCardMaxWidth()};
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  gap: 20px;
